...
function submit_edit_profile_form(){
    ...
    document.querySelector('.edit-profile-form').onsubmit = function() {
        ...
        refresh_user_profile(form_json) // Insert New Profile Data into DOM
...
function refresh_user_profile(form_json){
    ...
    // This function inserts the new form data into the Browser User Profile Section
...
function open_edit_post(e){
    ...
    .then(post_data => {
        if(response_status = 201){
            ...
            console.log("Javascript: assigning image to image field")
            if(post_data['image_file_url'] != null){
                console.log("Javascript: image received => ", post_data['image_file_url'])
                console.log("Javascript: typeof => ", typeof post_data['image_file_url'])
                document.querySelector('#post-image').value = post_data['image_file_url']
            }
            console.log("Javascript: Image assigned without error")
